...
/**
 * HistorialMedico
 * Lista cronológica de entradas del historial médico de una mascota
 *
 * Props:
 *   historial: array de EntradaHistorial
 */
...
/**
 * EntradaHistorial
 * Tarjeta de una entrada individual del historial
 */
const EntradaHistorial = ({ entrada }) => (
  ...
  >
    {/* Encabezado: fecha y veterinario */}
